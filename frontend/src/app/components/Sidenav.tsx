...
function NavLink({ href, children, onClick }: NavLinkProps) {
  return (
    <Link
      href={href}
      className="block px-4 py-3 text-xl font-serif hover:bg-opacity-80 transition rounded-md hover:underline"
      onClick={onClick}
    >
      {children}
    </Link>
...
export default function Sidenav() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <header className={`bg-gradient-to-b from-[#0254a6] to-[#00377c] text-white fixed left-0 h-screen w-64 shadow-lg transform transition-transform duration-300 ease-in-out z-40 ${isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
        }`}>
        <div className="flex flex-col h-full">
          ...
          {/* Bottom Navigation */}
          <div className=" border-opacity-20 p-4 space-y-2">
            <Link
              href="/help"
              className="flex items-center gap-3 px-4 text-lg font-serif hover:bg-opacity-80 transition rounded-md hover:underline"
              onClick={() => setIsOpen(false)}
            >
            ...
            <Link
              href="/profile"
              className="flex items-center gap-3 px-4 pb-4 text-lg font-serif hover:bg-opacity-80 transition rounded-md hover:underline"
              onClick={() => setIsOpen(false)}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
